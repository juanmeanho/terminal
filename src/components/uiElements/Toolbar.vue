<template>
  <div>
    ...
    <!-- Mini ToolBar para cuadros de busqueda en Sm devices -->
      ...
      <v-toolbar  color="transparent" height="100%" class="hidden-md-and-up mt-5 mb-5" card prominent >
        <v-container>
        <v-card width="100%" class="hidden-md-and-up" dark color="blue darken-1" >
          <v-layout class="mb-1" >
            <v-flex>
              <v-autocomplete
                :loading="loading"
  ...
  export default {
    ...
    computed:{
      ...
      switch (this.$vuetify.breakpoint.name) {
        ...
        case 'md': return 'extension'
        case 'lg': return 'extension'
        case 'xl': return 'extension'
      }
    },
      menuItems(){
        let menuItems = [
